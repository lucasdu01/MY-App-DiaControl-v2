...
type Props = {
    modalEditVisible: boolean;	// estado que controla a visibilidade do modal de registro de glicemia
    closeModalEdit: () => void;		// função que será chamada para fechar o modal de registro de glicemia
}

export function ModalEdit( {modalEditVisible, closeModalEdit} : Props) {
            ...
            <View style={styles.overlay}>
                <View style={styles.container}>
                    ...
                    <View style={styles.buttonsGroup}>
                        <ButtonSave />
                        <ButtonCancel onPress={() => closeModalEdit()}/>
                    </View>
                </View>
            </View>
        </Modal>
